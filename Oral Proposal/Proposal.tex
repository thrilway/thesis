...
\begin{frame}
  ...
  \ex. \textbf{Depictives}\\
  Amy ate the fish$_i$ [\textit{ec}$_i$ raw].

  \begin{itemize}
    \item \textbf{Short Answer:} $\Theta$-positions
      \begin{itemize}
	\item {\rm the fish} is the theme of {\rm ate} and of {\rm raw}
      \end{itemize}
...
\begin{frame}
  ...
  \begin{columns}
	...
	{UTAH}
	\begin{itemize}
	  \item \textcite{baker1988incorporation}: $\Theta$-roles are mapped to structural positions.
	    \begin{itemize}
	      \item Universal Theta Assignment Hypothesis
	    \end{itemize}
	  \item Baker proposes:
	    \pause
	    \begin{itemize}
