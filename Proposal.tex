...
\texcite{pietroski2003small} synthesizes these two approaches and proposes that \ref{ex:burn-tr} is ``derived'' from \ref{ex:burn-intr} does not mean \ref{ex:cause-to-burn}.
