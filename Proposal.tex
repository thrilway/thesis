...
This thesis shows how the variation could be acquired indirectly.
...
Chapter 3 develops a structural analysis of adjectival resultatives based on Kratzer's (\citeyear{kratzer_building_2004}) analysis but adapted to fit with syntactic theories such as UTAH \parencite{baker1997thematic} and the Movement Theory of Control \textcite{hornstein1999movement}.
...
Chapter 4 introduces \citeauthor{chomsky2013problems,chomsky2015problems}'s (\citeyear{chomsky2013problems,chomsky2015problems}) label theory, which says that phrase markers are generated without labels and must be labeled upon Transfer for proper interpretation at the CI interface.
