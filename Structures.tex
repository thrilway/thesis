...
(Discuss \textcite{postal1974raising,lasniksaito1999subject})
\subsection{Binding}
\subsection{NPI Licensing}
\subsection{Evidence from particle verbs}
The particle verb \textit{make out} is an ECM verb.
When it selects a non finite clause, subject of that clause must appear between the verb and its particle.
\ex. 
\a.* They made out John to be a liar.
