...
\ex.\label{tree:irimia-theta} Repeated from \ref{tree:irimia}\\
\begin{forest}
  nice empty nodes,sn edges,baseline
	[SituationP
...
In order to get from the structure in \ref{tree:irimia-theta} to the entailment in \Last, we would need to assume some mechanism by which the $\theta$-role of \textit{dry} is transferred to Situation.
