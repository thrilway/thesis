...
We could propose that there are, in fact, atleast two distinct structures for reslutatives: one corresponding to cases like \LLast, and another corresponding to cases like \Last.
...
This model of the grammar is composed of four parts:
	...
	and two interfaces, points at which a constructed expression is trasferred to language external modules for either externalization (the sensorimotor (SM) interface/module), or interpretation (the conceptual-intentional (CI) interface/module).
