...
It would have to mean that the label of a structure carries information about how it composes.
In particular, I propose that classes of labels are associated with modes of composition.
