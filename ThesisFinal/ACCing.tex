...
\subsection{Introduction}\label{sec:ECP}
...
\end{figure}
The next stages of the derivation requires the DP \textit{Joanna} to move out of the AC, leaving us with an unlabellable structure as per the discussion above in \cref{sec:ECP}.
...
Since the AC in this case is adjoined to VP, and, by hypothesis, the labelling algorithm operates only on the host of a host-adjunct structure, then the AC is not processed by the labelling algorithm.
