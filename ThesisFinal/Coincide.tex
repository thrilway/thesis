...
\begin{array}[t]{rcl}
	\textsc{sem}(\langle \text{Prog}_{\Theta}\text{P}, \text{VP}) &=& \lambda e\exists e^{\prime},e^{\prime\prime}[\textbf{see}(e)\\
...
The issue with this hypothesis is that it requires the ACC-ing clause to be an argument of the perception verb, rather than an adjunct.
