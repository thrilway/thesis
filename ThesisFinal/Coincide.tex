...
Now consider \cref{ex:ITCORunSeen}, which enatils that an event of someone seeing Sadie is included in an event of Sadie running.
...
The question comes down to a contrast between how argument ACC-ing structures and adjunct ACC-ing structures are intepreted, respectively, and therefore asking the question will require us to disambiguate the two structures.
...
To this end, I propose the use of direct percetion reports in which the perceived event is potentially imperceptible.
