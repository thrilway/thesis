...
The Prog$_{\theta}$P interpretation will be \cref{ex:ProgPAdHoc}, and the host VP interpretation will be \cref{ex:VPSimple}.
\ex.\label{ProgPAdHoc} $
\begin{array}[t]{rcl}
...
\begin{figure}[h]
	...
	\end{forest}
	\caption{The labelled structure of \cref{ex:ACC-ing} required by the \textit{see}$_{\Theta}$ proposal}
	\label{fig:AdHocTree2}
\end{figure}
This structure, however, is untenable for two reasons, which I discuss below.
<++>
