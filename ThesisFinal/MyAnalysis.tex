...
The Copy+Merge theory of movement allows us to derive sideward movement by holding the copied object in the workspace while another tree is built as in the derivation of \cref{fig:hammer-flat} in \Next.
\ex.
\begin{tabular}[t]{lll}
	\textbf{Stage} & \textbf{Workspace} & \\
	\cline{1-2}
