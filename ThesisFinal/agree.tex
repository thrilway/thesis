...
Most syntacticians assume a \textit{dep} head following \textcite{pylkk<++>}<++>.
Pylll\"anen, however, does not argue for the presence of a \textit{dep} head, but posits the head based on the assumption that it is necessary to encode depictive semantics.
