...
In other words, our grammar should generate \autoref{ex:FreCop} and \ref{ex:FreDep} but not \ref{ex:FreRes}.
\exg. \label{ex:FreCop}Le m\'etal est plat.\\
The.MSg metal is flat.MSg\\
``The metal is flat.''
...
So, a depictive VP has the structure represented in \autoref{fig:FreDepVP}.
\begin{figure}[h]
	\centering
	\begin{forest}
	...
	\label{fig:FreDepVP}
\end{figure}
As for the coincidence interpretation, I will postpone that discussion until a \autoref{sec:coincidence}.
...
In \autoref{sec:nonstandard}, I stated my assumption that syntactic agreement occurs outside of the Narrow Syntax.
