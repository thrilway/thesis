...
These demonstrations combined with the hypothesis that the parameter in \Next determines whether a language allows resultatives represent an explanation the resultative parameter, that is, how resultatives are acquired, parameterized, and generated.
