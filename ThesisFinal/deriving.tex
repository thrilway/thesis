...
These demonstrations, taken with the hypothesis that the parameter in \Next determines whether or not a language allows BSC and resultatives, constitutes an explanation of how resultatives are acquired, parameterized, and generated.
