...
The demonstration that Snyder's results can be derived from the presence/absence of $\varphi$-fetures on adjectives, however, is highly technical, based on a non-standadard version of so-called minimalist theory.
In \cref{sec:nonstandard}, I argue that the non-standard aspects of my theory, in fact, follow from the entirely standard assumptions in contemporary syntactic theory, which I discuss in detail in \cref{sec:standard}.
...
While this derivation might seem to fully explain the resultative parameter, and therefore fulfill the stated goal of my thesis, \cref{sec:deriving} is only ends \cref{sec:part1} of my thesis.
