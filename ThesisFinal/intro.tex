...
A canonical example of an adjectival resultative is given in \cref{ex:AREx}.
...
``John painted the house \textit{in} the colour red''\rcommentg{(Russian)}
...
For reasons that have little to do with the content of linguistic theory or its empirical base and a great deal to do with the social, cultural, and political atmosphere of modern scientific research, the two questions that I have posed above are not commonly treated as interdependent.
...
While the Y Model and Merge seem to be the only instances of true consensus among minimalist syntacticians, there is growing agreement about the underlying representation of certain types of words.
